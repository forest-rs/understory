...
/// ## See Also
///
/// `understory_event_state` for deriving hover enter/leave transitions from
...
///
/// The returned path may be passesd to the `HoverState`'s `update_path` method from `understory_event_state` to compute hover transitions.
